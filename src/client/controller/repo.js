...
module.controller('RepoCtrl', ['$scope', '$stateParams', '$HUB', '$RPC', '$modal', '$FilterSet', 'repo',
...
module.controller('AddBotCtrl', ['$scope', '$stateParams', '$modalInstance', 'bot',
    function($scope, $stateParams, $modalInstance, bot) {
