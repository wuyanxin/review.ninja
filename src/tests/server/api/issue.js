    ...
    it('should call the github api to create an issue with a file reference', function(done){
        var githubStub = sinon.stub(github, 'call', function(args, done) {
            ...
            var body = 'Test body\r\n\r\n' +
                       ...
                       '|------|--------------|---|\r\n' +
                       '|*commitsha*|[src/tests/server/api/issue.js#L24](https://github.com/reviewninja/review.ninja/blob/*commitsha*/src/tests/server/api/issue.js#L24)|[![#1](https://review.ninja/assets/images/icon-alt-36.png)](https://review.ninja/reviewninja/review.ninja/pull/1)|';
    ...
    it('should call the github api to create an issue with no file reference', function(done){
        var githubStub = sinon.stub(github, 'call', function(args, done) {
            ...
            var body = 'Test body\r\n\r\n' +
                       '|commit|file reference|   |\r\n' +
                       '|------|--------------|---|\r\n' +
                       '|*commitsha*|`none`|[![#1](https://review.ninja/assets/images/icon-alt-36.png)](https://review.ninja/reviewninja/review.ninja/pull/1)|';
            assert.equal(args.arg.body, body);
            assert.equal(args.arg.labels[0], 'review.ninja');
            done(null, null);
        });
