...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            'https://cdnjs.cloudflare.com/ajax/libs/angular-strap/2.0.0/angular-strap.min.js',
            'https://cdnjs.cloudflare.com/ajax/libs/angular-strap/2.0.0/angular-strap.tpl.min.js',
